...
# Force UTF-8 encoding for production environments (fixes Unicode errors)
...
# UTF-8 Character Encoding (prevents UnicodeEncodeError in production)
...
EMAIL_USE_TLS = os.getenv('EMAIL_USE_TLS', 'False') == 'True'  # Fixed: was == 'False'
